...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2022 at 06:18 PM
...
INSERT INTO `claim` (`id`, `name`, `email`, `fir_no`, `cplc`, `date`, `despt`, `claim_no`, `c_date`, `status`, `imei_1`, `imei_2`, `customer_id`) VALUES
(32, ' waqas', ' ali@gmail.com', '5665', '98898', '2022-09-14T13:36', 'kj', '2016744551', '2022-09-10 08:32:28', 'Pending', '77777777', '77777778', 53);
...
(53, 'waqas', '123', 'pakistan', 'karachi', ' 03322474948', 'karachi', 'cover1.jpg', ' ::1', 'ali@gmail.com', 1),
(54, 'ROMAIL', '123', 'pakistan', 'karachi', ' 030303', 'karachi', 'eccomce.png', ' ::1', 'romail69@gmail.com', 1),
(55, 'asad', '123', 'pakistan', 'karachi', ' 03322474948', 'karachi', 'cover1.jpg', ' ::1', 'asad@gmail.com', 1),
(56, 'waqas', '123', 'pakistan', 'KARACHI', ' 03322474948', 'karachi', 'eccomce.png', ' ::1', 'romail69s@gmail.com', 1),
(57, 'waqas', '', 'pakistan', 'KARACHI', ' 03322474948', 'karachi', 'eccomce.png', ' ::1', 'romail69s@gmail.com', 1),
(58, 'waqas', '', 'pakistan', 'KARACHI', ' 03322474948', 'karachi', 'eccomce.png', ' ::1', 'romail69s@gmail.com', 1),
(59, 'hamza', '123', 'PY', 'KARACHI', ' 03322474948', 'karachi', 'eccomce.png', ' ::1', 'hamza@gmail.com', 1),
(60, 'ROMAIL', '123', 'Afghanistan', 'karachi', ' cc', 'karachi', '', ' ::1', 'hamza@gmail.com', 1),
(61, 'waqas', '123', 'Papua New Guinea', 'karachi', ' 03322474948', 'nnn', 'eccomce.png', ' ::1', 'hamza@gmail.com', 1),
(62, 'waqas', '123', 'Lebanon', 'karachi', ' 5345345', 'naruto uzumaki', 'db17437cf6994337a1b7c5c81fa16d87.png', ' ::1', 'hamza@gmail.com', 1);
...
(115, 53, 101, 999, 2042840244, 1, 'select Option', '2022-09-10 10:43:50', 'Paid', 'Delete Order', 2),
(116, 53, 102, 3000, 774716868, 1, 'select Option', '2022-09-10 10:48:08', 'Paid', 'InComplete', 2),
(117, 59, 92, 34499, 208275608, 1, 'select Option', '2022-09-10 16:11:01', 'Paid', 'InComplete', 2);
...
(69, 2042840244, 53, 999, 'Jazzcash', 23232312, '2022-09-10 10:43:12', 'Recived', ' Full Payment ', '5656776655666'),
(70, 774716868, 53, 3000, 'Jazzcash', 90900, '2022-09-10 10:48:08', 'Recived', ' Full Payment ', '5656776655666'),
(71, 208275608, 59, 34499, 'Bank transfer', 2147483647, '2022-09-10 16:11:01', 'Recived', ' 12 -  2874', '878989879');
...
--
ALTER TABLE `customers`
  MODIFY `customer_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `payments`
  MODIFY `payment_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `claim`
  ADD CONSTRAINT `claim_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`);
...
ALTER TABLE `customer_order`
  ...
  ADD CONSTRAINT `customer_order_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
