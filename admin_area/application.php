...
<head>
    ...
    <title>Recend Applications</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Recend  Applications</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content row-1">
         ...
         ?>
                                ...
                                <thead>
                                   ...
                                   <?php
                                   $i=0;
                                   $get_orders="SELECT * FROM claim Where status='pending'";
                                   ...
                                   ?>
                                        <tr>
                                         <th scope="row"><?php echo $i?></th>
                                            ...
                                            <a  class="btn btn-danger btn-sm" href="index.php?delete-application=<?php  echo  $id ?>"> Delete</a>                                        </tr>
                                                                          </tr>
