   ...
   ?>
    ...
    <div class="panel-body"><!--  panel-body Begin  -->
        ...
        <ul class="nav-pills nav-stacked nav"><!--  nav-pills nav-stacked nav Begin  -->
            ...
            <li class="<?php if(isset($_GET['claim'])){ echo "active"; } ?>">
                
                <a href="my_account.php?claim">
                    

                    
                <i class="fa fa-paper-plane" aria-hidden="true"></i> Claim Application
                    
                </a>
                
            </li>

            <li class="<?php if(isset($_GET['claim-list'])){ echo "active"; } ?>">
                
                <a href="my_account.php?claim-list">
                    

                    
                <i class="fa fa-list"></i> Claim Status
